...
export const darkTheme: ThemeConfig = {
  ...
  variables: {
    ...
    '--card-bg-solid': '#111b33',
    '--card-bg-hover': 'rgba(20, 28, 50, 0.85)',
    ...
    '--glow-secondary': '0 0 40px rgba(59, 130, 246, 0.1)',
    '--glow-warm': '0 0 40px rgba(245, 158, 11, 0.1)',

    '--gradient-hero': 'linear-gradient(135deg, #0a0e1a 0%, #1a1040 40%, #0f1629 70%, #0a1628 100%)',
    '--gradient-card': 'linear-gradient(135deg, rgba(139, 92, 246, 0.05) 0%, rgba(59, 130, 246, 0.03) 100%)',
    ...
    '--topbar-border': 'rgba(139, 92, 246, 0.08)',
    '--topbar-height': '64px',
    ...
    '--scrollbar-bg': 'rgba(15, 22, 41, 0.5)',
